...
module.exports = ( req, res ) => {
	...
	save.on( 'error', e => res.respond( new Response( e.statusCode || 500, e.stack || e.message || e ) ) );
	req.on( 'error', e => res.respond( new Response( e.statusCode || 500, e.stack || e.message || e ) ) );
